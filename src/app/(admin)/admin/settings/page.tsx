...
export default function AdminSettingsPage() {
  return (
    <>
      <PageHeader
        title="Settings"
        description="Review platform administrator preferences, notification controls, and sign-out state."
      />
      ...
      <Card className="flex items-center justify-between gap-4">
        <div>
          ...
          <p className="mt-2 text-sm text-[var(--color-ink-600)]">Sign out after reviewing the admin workspace.</p>
        </div>
        <SignOutButton />
      </Card>
    </>
