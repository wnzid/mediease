    ...
    dashboard: {
      ...
      nextAppointment: {
        ...
        empty: "Jūs neturite suplanuotų vizitų. Užsirašykite, kai būsite pasiruošę.",
          ...
          appointmentsPage: {
            description: "Stebėkite artėjančius vizitus, peržiūrėkite ankstesnius apsilankymus ir atidarykite kiekvieną vizitą, kad gautumėte detales.",
            upcoming: "Artimiausi",
            past: "Praėję",
            emptyTitle: "Dar nėra vizitų",
            emptyDescription: "Kai užsisakysite vizitą, jis bus rodomas čia su būsenos atnaujinimais ir vizito informacija.",
            emptyActionLabel: "Užsirašyti vizitui",
            signInTitle: "Dar nėra vizitų",
            signInDescription: "Prisijunkite, kad peržiūrėtumėte savo vizitus.",
